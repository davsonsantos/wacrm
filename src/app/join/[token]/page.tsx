...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Verifique o URL ou peça à pessoa que o convidou que envie um novo.',
  },
  used: {
    title: 'Convite já utilizado',
    body: 'Este convite já foi aceito. Se não foi você, peça ao administrador da conta que envie um novo link.',
  },
  expired: {
    title: 'Convite expirado',
    body: 'Este convite expirou. Peça ao administrador da conta que envie um novo — leva alguns segundos para gerar.',
  },
  server_error: {
    title: 'Algo deu errado',
    body: 'Não foi possível verificar este convite agora. Tente atualizar a página daqui a pouco.',
  },
};
          ...
          {peek.reason === 'server_error' ? (
            <>
              ...
              <Link href="/signup">
                ...
                >
                  Criar uma nova conta em vez disso
                </Button>
              </Link>
            </>
          ) : (
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              Ao aceitar, seu login passará para{' '}
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                saia e crie uma conta novamente com um endereço de e-mail
