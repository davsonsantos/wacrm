      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Tokens gastos na chave do seu provedor por rascunhos e pelo bot
              de respostas automáticas. Apenas contagens — nenhum conteúdo de
      ...
      <CardContent className="space-y-5">
        {loading || !data ? (
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-10 text-center text-sm text-muted-foreground">
            ...
            <p className="text-xs">
              Isto é preenchido à medida que o assistente cria rascunhos e responde automaticamente.
            </p>
          </div>
        ) : (
          <>
            ...
            {data.truncated && (
              <p className="text-xs text-muted-foreground">
                Mostrando uma janela parcial — o uso é alto o suficiente para que
